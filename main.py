        ...
        if risk > 0:
            ...
            if rr >= RISK_REWARD_MIN_A:
                ...
                return {
                    ...
                    "grade": "A",
                    "trigger": trigger,
                    "reason": "4h/1h bullish, 15m bestätigt, kein Chop, Trend-Setup.",
                }
        ...
        if risk > 0:
            ...
            if rr >= RISK_REWARD_MIN_A:
                ...
                return {
                    ...
                    "grade": "A",
                    "trigger": trigger,
                    "reason": "4h/1h bearish, 15m bestätigt, kein Chop, Trend-Setup.",
                }
        ...
        if risk > 0:
            ...
            if rr >= RISK_REWARD_MIN_B:
                ...
                return {
                    ...
                    "grade": "B",
                    "trigger": trigger,
                    "reason": "Solides Setup, aber nicht stark genug für Discord.",
                }
...
def format_signal(sig):
    ...
    return (
        ...
        f"Qualität: {sig['grade']} | Score: {sig['score']}/7\n"
...
def main():
    ...
    try:
        ...
        if SEND_STARTUP_MESSAGE:
            safe_discord("✅ Safe Pro Signal Bot V3 gestartet. BTC und SOL werden überwacht.")
