...
def analyze(coin, market_ctx, prev_ctx, market_bias, flip_state, regime, state):
    ...
    if trigger is None:
        trigger = "Trend Long" if side == "LONG" else "Trend Short"
...
def main():
    ...
    if SEND_STARTUP_MESSAGE:
        safe_discord(state, "✅ V13.3 QUANT HYBRID ANTI-CHASE BOT AKTIV", dedupe_key="startup")
