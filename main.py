...
API_RETRY_SLEEP = float(os.getenv("API_RETRY_SLEEP", "3"))
...
def analyze(coin, market_ctx, prev_ctx, btc_bias, state):
    c15 = candles(coin, "15m", 150)
    c1 = candles(coin, "1h", 100)
...
def main():
    ...
    if SEND_STARTUP_MESSAGE:
        safe_discord(state, "✅ RECOVERY BOT AKTIV", dedupe_key="startup")
