...
OI_RISE_THRESHOLD = float(os.getenv("OI_RISE_THRESHOLD", "0.0015"))  # 0.15%
...
def main():
    ...
    try:
        ...
        if SEND_STARTUP_MESSAGE:
            safe_discord("✅ Safe Pro Signal Bot V6 gestartet. Multi-Coin Scan aktiv.")
        ...
        while True:
            ...
            try:
                ...
                # Markt-Kontext speichern für nächsten Scan
                state["market_ctx"] = {
                    c: {
