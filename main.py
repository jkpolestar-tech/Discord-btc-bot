...
def maybe_send_heartbeat(state):
    ...
    if now.hour == HEARTBEAT_HOUR_UTC and state.get("last_heartbeat_date") != today:
        safe_discord("💓 Bot läuft. Regime + Risk Control + Entry Delay aktiv.")
...
def main():
    ...
    try:
        ...
        if SEND_STARTUP_MESSAGE:
            safe_discord("✅ Regime Bot gestartet. Trend/Range/Chaos + Entry Delay + First Trade Bias aktiv.")
